...
# [MIT License]
# - Original
#   - Developer: Thomas Mielke (https://github.com/thomiel)
#   - Source: https://github.com/Thomas-Mielke-Software/maui-docker
# - Podman-version
#   - Developer: Lemon73 (https://github.com/Lemon73-Computing)
#   - Source: https://github.com/Lemon73-Computing/maui-linux
# - - - - -
...
# Add missing version bands
RUN sed -i 's/"8.0.100", "8.0.200"}/"8.0.100", "8.0.200", "8.0.300", "8.0.400"}/g' build.cake
